alert("Тоглоомын дүрэм бол 'АЗ' \n 1 буулгавал дараагийн тоглогчруу шилжинэ.");

// Тоглоомын бүх газарт ашиглагдах глобаль хувьсагчдыг энд зарлая

// тоглоом дууссан бхийг мэдэх хэсэг
var isNewGame;
...
function initGame() {
  ...
  document.getElementById("name-0").textContent = "Араатан";
  document.getElementById("name-1").textContent = "Гүнж";
...
document.querySelector(".btn-roll").addEventListener("click", function() {
  if (isNewGame) {
    ...
    alert("Тоглоом дууссан.Шинээр эхэлнэ үү!");
  }
});
...
document.querySelector(".btn-hold").addEventListener("click", function() {
  ...
  if (scores[activePlayer] >= 50) {
    //   togloomiin tolov duussan esehiig shalgah
    isNewGame = false;
